...
The model for User Account describes user accounts in the portal. The following fields are currently supported for this model:
...
You can find more examples [here](/docs/user-account/examples.html). 
